document.addEventListener("DOMContentLoaded", () => {
  ...
  const rSStrainBtn = document.querySelector(".bacteria-option.Heat-killedpl");
  ...
  rSStrainBtn.addEventListener("click", () => {
    injectRStrain();
  });
  ...
  function injectRStrain() {
    ...
    addOrUpdateLabel(testBox, "Heat-killed S + live R");
  }
