document.addEventListener("DOMContentLoaded", () => {
  ...
  const heatKilledSBtn = document.querySelector(".bacteria-option.Heat-killed"); // Heat-killed S strain
  ...
  function injectHeatKilledS() {
    ...
    addOrUpdateLabel(testBox, "Heat-killed S strain"); // ცვლილება
  }
